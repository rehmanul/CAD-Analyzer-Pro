...
class GeometricElementRecognizer:
    ...
    def __init__(self):
        ...
        # Geometric analysis parameters - more permissive for better detection
        self.min_wall_length = 50  # mm (reduced from 100)
        self.wall_thickness_tolerance = 200  # mm (increased from 50)
        self.connection_tolerance = 50  # mm (increased from 10)
        # Analysis parameters
